        ...
        <div className="contact-modern__container">
          ...
          <div className="contact-modern__info">
            ...
            <div className="contact-modern__column">
              ...
              <a className="contact-modern__value" href="mailto:DOMBERG39@gmail.com">DOMBERG39@gmail.com</a>
            </div>
            <div className="contact-modern__column">
              <p className="contact-modern__label">Соц. сети</p>
              <div className="contact-modern__socials">
                <a href="https://www.instagram.com/DOMBERG39" target="_blank" rel="noopener noreferrer"><FaInstagram /></a>
                <a href="https://t.me/DOMMBERG" target="_blank" rel="noopener noreferrer"><FaTelegramPlane /></a>
