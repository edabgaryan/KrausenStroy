        ...
        <div className='about__welcome'>
          <div className='about__w-box'>
            <h2 className='w-box__title'>DOMAIZBLOKOV</h2>
              <p className='w-box__paragraph'>DOMAIZBLOKOV зарекомендовала себя как надежный партнер в сфере проектирования и строительства домов. Мы специализируемся на создании современных, комфортных и функциональных решений для жилья из газобетона. Наша команда состоит из опытных специалистов, которые пристально следят за всем циклом работ — от концепции до завершения проекта.</p>
